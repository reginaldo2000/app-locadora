...
<head>
    ...
    <link rel="stylesheet" href="<?= URL_BASE . "/resources/css/style.css" ?>">
</head>
...
<body>
    ...
    <nav class="navbar-sl-main">
        <ul>
            ...
            <li><a href="<?= URL_BASE . "/categoria/show" ?>">Categorias</a></li>
    ...
    <script src="<?= URL_BASE . "/resources/js/main.js" ?>"></script>
    <?= $this->section("script") ?>
</body>
